			...
			<div class="tinv-modal-inner">
				...
				<div class="tinvwl-buttons-group tinv-wishlist-clear">
					<?php if ( isset( $wishlist_url ) ) : ?>
						<button class="button tinvwl_button_view tinvwl-btn-onclick as-btn"
					...
					<?php endif; ?>
					<button class="button tinvwl_button_close as-btn" type="button"><i
								class="ftinvwl ftinvwl-times"></i><?php esc_html_e( 'Close', 'taxseco' ); ?>
					</button>
				</div>
