...
add_filter( 'loop_shop_per_page', 'taxseco_new_loop_shop_per_page', 20 );
function taxseco_new_loop_shop_per_page( $product_count ) {
    if( class_exists('ReduxFramework') ) { 
        $product_count = taxseco_opt( 'taxseco_woo_product_perpage' );
    }else{
        $product_count = 12;
    }
...
add_filter('woocommerce_product_loop_start','taxseco_woocommerce_product_loop_start');
function taxseco_woocommerce_product_loop_start( ) {
    echo '<div class="row">';
}

// wooocommerce product loop start filter
add_filter('woocommerce_product_loop_end','taxseco_woocommerce_product_loop_end');
function taxseco_woocommerce_product_loop_end( ) {
    echo '</div>';
}

// woocommerce format sale price
add_filter('woocommerce_format_sale_price','taxseco_woocommerce_format_sale_price',10,3);
function taxseco_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','taxseco_woocommerce_review_gravatar_size');
function taxseco_woocommerce_review_gravatar_size() {
    return 65;
}
...
add_filter('woocommerce_output_related_products_args','taxseco_woocommerce_output_related_products_args',10,1);
function taxseco_woocommerce_output_related_products_args( $args ) {
    if( class_exists('ReduxFramework') ) {
        $args['posts_per_page'] = taxseco_opt('taxseco_woo_relproduct_num');
    } else {
...
add_filter('woocommerce_upsell_display_args','taxseco_woocommerce_upsell_display_args',10,1);
function taxseco_woocommerce_upsell_display_args( $args ) {
    if( class_exists('ReduxFramework') ) {
        $args['posts_per_page'] = taxseco_opt('taxseco_woo_upsellproduct_num');
    } else {
        $args['posts_per_page'] = '3';
    }
    return $args;
...
function woocommerce_cross_sells_total( $limit ) {
    if( class_exists('ReduxFramework') ) {
        $limit = taxseco_opt('taxseco_woo_crosssellproduct_num');
    } else {
        $limit = '3';
    }
...
// Ajax Cart Count
add_filter( 'woocommerce_add_to_cart_fragments', 'taxseco_refresh_mini_cart_count');
function taxseco_refresh_mini_cart_count($fragments){
    ob_start();
    ?>
...
// Checkout fields
add_filter( 'woocommerce_checkout_fields' , 'taxseco_override_checkout_fields' );
function taxseco_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'taxseco');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'taxseco');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'taxseco');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'taxseco');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'taxseco');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'taxseco');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'taxseco');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'taxseco');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'taxseco');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'taxseco');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'taxseco');
...
add_filter( 'woocommerce_default_address_fields', 'taxseco_override_default_locale_fields' );
function taxseco_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'taxseco_custom_billing_fields' );
function taxseco_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'taxseco');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'taxseco');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'taxseco');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'taxseco');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'taxseco');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'taxseco');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'taxseco');
...
add_filter( 'woocommerce_shipping_fields' , 'taxseco_custom_shipping_fields' );
function taxseco_custom_shipping_fields( $fields ) {

    // Shipping Fields

    $fields['shipping_first_name']['class'] = array('col-lg-6');
    $fields['shipping_first_name']['input_class'] = array('form-control');
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'taxseco');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'taxseco');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'taxseco');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'taxseco');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'taxseco');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'taxseco');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'taxseco');
...
add_action('woocommerce_before_main_content','taxseco_shop_col_start_cb');

// Shop column end wrapper hook
add_action('woocommerce_after_main_content','taxseco_shop_col_end_cb',10);

// shop main content hook
add_action('taxseco_shop_main_content','taxseco_shop_main_content_cb',10);

// shop main content end hook
add_action('taxseco_shop_main_content_end','taxseco_shop_main_content_end_cb',10);

// taxseco woocommerce pagination hook
add_action('woocommerce_after_shop_loop','taxseco_woocommerce_pagination',10);

// taxseco woocommerce filter wrapper hook
add_action('woocommerce_before_shop_loop','taxseco_woocommerce_filter_wrapper',20);

// taxseco woocommerce product content wrapper
add_action('taxseco_woocommerce_product_content', 'taxseco_woocommerce_tab_content_wrapper_start', 10 );
add_action('taxseco_woocommerce_product_content', 'taxseco_grid_tab_content_cb', 10 );
add_action('taxseco_woocommerce_product_content', 'taxseco_list_tab_content_cb', 20 );
add_action('taxseco_woocommerce_product_content', 'taxseco_woocommerce_tab_content_wrapper_end', 30 );

// taxseco woocommerce get sidebar
add_action('woocommerce_sidebar','taxseco_woocommerce_get_sidebar',10);

/*
*   Content Product Hook
*/

// taxseco shop loop product thumbnail hook
add_action( 'woocommerce_before_shop_loop_item', 'taxseco_loop_product_thumbnail', 10 );

// taxseco shop loop hozrizontal product thumbnail hook
add_action( 'woocommerce_before_shop_horizontal_loop_item', 'taxseco_loop_horiontal_product_thumbnail', 10 );

// taxseco shop loop horizontal product summary hook
add_action('taxseco_woocommerce_shop_three_loop_product_summary','taxseco_woocommerce_shop_three_loop_product_summary_cb',10);

/*
*   Single Product Hook
*/
// single product before summary
add_action('woocommerce_before_single_product_summary', 'taxseco_woocommerce_before_single_product_summary',10);

// single product title
add_action('woocommerce_single_product_summary', 'taxseco_woocommerce_single_product_title', 30 );

// single product price and rating
add_action('woocommerce_single_product_summary', 'taxseco_woocommerce_single_product_price_rating', 20 );

// single product excerpt
add_action('woocommerce_single_product_summary', 'taxseco_woocommerce_single_product_excerpt', 40 );

// single product availability
add_action( 'woocommerce_single_product_summary', 'taxseco_woocommerce_single_product_availability', 50 );

// single product add to cart button
add_action('woocommerce_single_product_summary','taxseco_woocommerce_single_add_to_cart_button',60);

// single product meta hook
add_action('woocommerce_single_product_summary','taxseco_woocommerce_single_meta',80);

// single product sidebar
add_action('taxseco_woocommerce_single_product_sidebar','taxseco_woocommerce_single_product_sidebar_cb');

/*
* Single product quick view
*/
add_action('taxseco_quickview_before_single_product_summary','taxseco_woocommerce_before_single_product_summary',10);

// single product price and rating
add_action('taxseco_quickview_single_product_summary','taxseco_woocommerce_single_product_price_rating',20);

// single product title
add_action('taxseco_quickview_single_product_summary','taxseco_woocommerce_quickview_single_product_title',30);

// single product excerpt
add_action('taxseco_quickview_single_product_summary','taxseco_woocommerce_single_product_excerpt',40);

// single product add to cart button
add_action('taxseco_quickview_single_product_summary','taxseco_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','taxseco_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','taxseco_woocommerce_button_proceed_to_checkout',20);

// cross sell products
add_action('woocommerce_after_cart','taxseco_woocommerce_cross_sell_display',10);

// mini cart view cart button
add_action('woocommerce_widget_shopping_cart_buttons','taxseco_minicart_view_cart_button',10);

// mini cart checkout button
add_action('woocommerce_widget_shopping_cart_buttons','taxseco_minicart_checkout_button',20);

/*
*   checkout hook
*/

// taxseco woocommerce checkout login form
add_action('woocommerce_before_checkout_form','taxseco_woocommerce_before_checkout_form',10);
...
add_filter( 'wooscp_button_html', 'taxseco_wooscp_button_html', 10, 2 );
function taxseco_wooscp_button_html( $output , $prodid ) {
...
add_filter( 'wooscp_button_text_added', 'taxseco_woo_compare_btn_text_added', 10, 2 );
function taxseco_woo_compare_btn_text_added( ){
    return $output = '<i class="fal fa-layer-group"></i>';
}

add_filter( 'wooscp_button_text', 'taxseco_compare_btn_text', 10, 2 );
function taxseco_compare_btn_text(){
    return $output = '<i class="fal fa-layer-group"></i>';
}
