...
function taxseco_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'taxseco' ),
        'next_string'     => esc_html__( '&raquo;', 'taxseco' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'taxseco_pagination_defaults', $defaults )
    );
