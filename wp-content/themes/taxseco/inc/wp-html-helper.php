...
// image default alt
if( !function_exists( 'taxseco_img_default_alt' ) ){
	function taxseco_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'taxseco_img_tag' ) ){
	function taxseco_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = taxseco_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'taxseco_anchor_tag' ) ){
	function taxseco_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'taxseco_heading_tag' ) ){
	function taxseco_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'taxseco_paragraph_tag' ) ){
	function taxseco_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'taxseco_span_tag' ) ){
	function taxseco_span_tag( array $args ){
