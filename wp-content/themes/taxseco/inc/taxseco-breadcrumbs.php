...
if ( ! function_exists( 'taxseco_breadcrumbs' ) ) {
    function taxseco_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'taxseco' )
        );
        $args    = apply_filters( 'taxseco_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','taxseco') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error 404', 'taxseco' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'taxseco_breadcrumbs_filter', $html );
        }
