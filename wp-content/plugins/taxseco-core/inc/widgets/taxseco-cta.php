...
class taxseco_cta_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Taxseco :: CTA Widget', 'taxseco' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add CTA Widget', 'taxseco' ),
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'cta_img_url' ); ?>"><?php _e( 'Image URL:' ,'taxseco'); ?></label>
            ...
            jQuery(function($){
                ...
                $( function(){
                    ...
                    $(document).on('widget-updated',function(event,widget){
                        ...
                        if(widget_id.indexOf('taxseco_cta_widget')!=-1){
                            $imgval = $(".img_val").val();
    ...
    } // Class taxseco_cta_widget ends here


    // Register and load the widget
    function taxseco_cta_load_widget() {
        register_widget( 'taxseco_cta_widget' );
    }
    add_action( 'widgets_init', 'taxseco_cta_load_widget' );